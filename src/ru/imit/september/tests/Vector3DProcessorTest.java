...
public class Vector3DProcessorTest {
    ...
    public void sum() {
        ...
        assertEquals(3,sum.getX(),0.001);
        assertEquals(9,sum.getY(),0.001);
        assertEquals(12,sum.getZ(),0.001);
    }
    ...
    public void difference() {
        ...
        assertEquals(1,dif.getX(),0.001);
        assertEquals(1,dif.getY(),0.001);
        assertEquals(0,dif.getZ(),0.001);
    }

    @Test
    public void scalarProduct() {
       assertEquals(58,Vector3DProcessor.scalarProduct(a,b),0.001);
    }
    ...
    public void vectorProduct() {
        ...
        assertEquals(-6,vect.getX(),0.001);
        assertEquals(-6,vect.getY(),0.001);
        assertEquals(-3,vect.getZ(),0.001);
    }
    ...
    @Test
    public void isCollinearTrue() {
        assertTrue(Vector3DProcessor.isCollinear(a,c));
    }
